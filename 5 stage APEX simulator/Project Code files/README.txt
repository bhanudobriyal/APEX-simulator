...
2) Run using ./apex_sim input.asm display 20 or ./apex_sim input.asm simulate 20
3) We can use any n number as the last argument as it is for the number of cycles we want to run.
